...
<header class="topbar" role="banner">
    ...
    <div class="topbar-left">
        <button type="button"
                class="sidebar-toggle topbar-btn"
                id="sidebar-toggle"
    ...
    <div class="topbar-center">
        <div class="topbar-search">
            <i class="fas fa-search topbar-search-icon" aria-hidden="true"></i>
            <input type="search"
    ...
    <div class="topbar-right">
        ...
        <button type="button"
                class="topbar-icon-btn topbar-btn"
                id="topbar-notif"
        ...
        <div class="topbar-user user-menu" id="user-menu">
            <button type="button" class="topbar-user-btn user-menu-trigger" id="user-menu-trigger" aria-haspopup="true" aria-expanded="false">
            ...
            <div class="user-dropdown" id="user-dropdown">
                <div class="dropdown-header">
                    <span class="dropdown-avatar"><?= strtoupper(substr($userName, 0, 1)) ?></span>
                    <div>
                ...
                <a class="dropdown-item" href="/admin?module=parametres">
                    <i class="fas fa-gear" aria-hidden="true"></i>
                    Parametres
                </a>
                <a class="dropdown-item dropdown-item-danger" href="/admin/logout.php">
