...
function displayStep2()
{
    $defaults = [
        ...
        'advisor_carte' => 'CPI 13004 2020 0000001',
        'advisor_rsac' => 'RSAC',
        'advisor_bio' => 'Expert en immobilier spécialisé dans les biens sur Aix-en-Provence et le Pays d\'Aix.',
    ];
    ?>
    <form method="post" action="agence-init.php" class="install-form">
