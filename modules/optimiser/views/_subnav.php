...
.optimiser-subnav__pill:hover{border-color:#c9a84c;color:#7c5d1d}
.optimiser-subnav__pill--active{background:linear-gradient(135deg,#c9a84c,#b8943d);color:#0f2237;border-color:transparent}
</style>
