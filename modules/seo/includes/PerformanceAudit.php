<?php
/** @deprecated SEO legacy freeze: no new feature here. Use modules/seo/services/SeoTechnicalPerformanceService.php */
declare(strict_types=1);

require_once __DIR__ . '/../_legacy_guard.php';
seoLegacyGuard('modules/seo/includes/PerformanceAudit.php', 'modules/seo/services/SeoTechnicalPerformanceService.php');
