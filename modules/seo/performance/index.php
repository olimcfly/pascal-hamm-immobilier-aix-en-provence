...
$performanceRunUrl = function_exists('admin_url')
    ? admin_url(['module' => 'seo', 'action' => 'performance_run'])
    : '/admin/?module=seo&action=performance_run';
...
<section class="seo-section seo-performance-dashboard">
    ...
    <div class="seo-headline">
        ...
        <form method="post" action="<?= htmlspecialchars($performanceRunUrl, ENT_QUOTES, 'UTF-8') ?>">
            <?= csrfField() ?>
