...
// ── Paramètres DB (setting, settings_save, replacePlaceholders) — requis pour le module profil et le layout
...
if (file_exists(ROOT_PATH . '/core/services/EmailSequencePriorityService.php')) {
