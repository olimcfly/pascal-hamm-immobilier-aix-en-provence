...
$stmt = $pdo->query("SELECT * FROM biens WHERE statut = 'vendu' AND photo_principale IS NOT NULL AND photo_principale != '' AND photo_principale NOT LIKE '%default.jpg%' ORDER BY created_at DESC");
