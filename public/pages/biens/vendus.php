...
$pageDescription = 'Découvrez les biens récemment vendus sur Aix-en-Provence et le Pays d’Aix (13).';
...
$stmt = $pdo->query(
    "SELECT * FROM biens WHERE statut = 'vendu' AND "
...
<section class="hero hero--premium">
    ...
    <div class="container">
        <div class="hero__content">
            ...
            <h1>Biens récemment vendus — Aix &amp; Pays d’Aix</h1>
...
<section class="cta-banner">
    <div class="container">
        <h2>Vous souhaitez vendre votre bien sur Aix ou les environs ?</h2>
