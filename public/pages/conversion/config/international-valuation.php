...
return [
    'advisor' => [
        ...
        'zone' => trim((string) setting('advisor_zone', 'Pays d’Aix (13)')),
    ...
    'locales' => [
        'fr' => [
            ...
            'og_locale' => 'fr_FR',
            'meta' => [
                'title' => 'Estimation immobilière Aix-en-Provence | Accompagnement local',
                'description' => 'Estimation immobilière sur Aix-en-Provence et le Pays d’Aix, avec accompagnement humain pour vendre ou acheter sereinement.',
            ],
            'hero' => [
                'label' => 'Estimation immobilière — Pays d’Aix',
                'title' => 'Vendre ou acheter sur Aix commence par une estimation juste.',
            ...
            'motivation' => [
                'title' => 'Vous connaissez votre projet. Nous apportons la lecture du marché local.',
                'text' => 'Sur Aix et le Pays d’Aix, deux rues proches peuvent afficher des écarts de valeur importants. Sans repères locaux, il est facile de surévaluer, sous-évaluer ou rater une opportunité.',
            ],
            'positioning' => [
                'title' => 'Un conseiller de proximité pour un projet exigeant',
                'text' => trim((string) setting('advisor_fullname', ADVISOR_NAME)) . ' accompagne vendeurs, acheteurs et expatriés avec une méthode claire : données de marché, stratégie personnalisée et suivi continu.',
                'points' => [
                    'Connaissance terrain : Aix-en-Provence et le Pays d’Aix (13).',
            ...
            'reassurance' => [
                ...
                'faq' => [
                    ...
                    ['q' => 'Intervenez-vous hors centre-ville ?', 'a' => 'Oui, sur Aix-en-Provence et les communes du Pays d’Aix.'],
                ],
            ],
            'finalCta' => [
                'title' => 'Parlons de votre projet immobilier sur Aix & le Pays d’Aix',
        ...
        'en' => [
            ...
            'meta' => [
                ...
                'description' => 'Get a local property valuation in Aix and the Pays d’Aix with premium, human support for sellers, buyers and expatriates.',
            ],
            'hero' => [
                'label' => 'Aix-en-Provence — property valuation',
                'title' => 'Make confident property decisions in Aix and the surrounding area.',
            ...
            'motivation' => [
                ...
                'text' => 'In Aix and the Pays d’Aix, pricing can shift significantly between nearby streets and neighborhoods. International buyers and expats need local context to avoid costly mistakes.',
            ],
            'positioning' => [
                'title' => 'A local advisor with an international mindset',
                'text' => trim((string) setting('advisor_fullname', ADVISOR_NAME)) . ' provides structured guidance for sales and acquisitions, with straightforward communication and reliable local execution.',
                'points' => [
                    'On-the-ground knowledge of Aix-en-Provence and the Pays d’Aix.',
            ...
            'finalCta' => [
                ...
                'text' => 'Get practical guidance for your next move in Aix and the Pays d’Aix.',
        ...
        'es' => [
            ...
            'meta' => [
                ...
                'description' => 'Solicita una valoración inmobiliaria en Aix y el Pays d’Aix, con asesoramiento cercano para vendedores, compradores y clientes internacionales.',
            ],
            'hero' => [
                'label' => 'Valoración inmobiliaria — Pays d’Aix',
                'title' => 'Tu proyecto inmobiliario merece una valoración local y realista.',
                'subtitle' => 'Acompañamiento profesional y humano para vender o comprar con seguridad en Aix y alrededores.',
            ...
            'motivation' => [
                ...
                'text' => 'En Aix y el Pays d’Aix hay diferencias de precio importantes entre zonas muy cercanas. Para un comprador o vendedor internacional, la orientación local marca la diferencia.',
            ],
            'positioning' => [
                'title' => 'Asesoramiento cercano, criterio profesional',
                'text' => trim((string) setting('advisor_fullname', ADVISOR_NAME)) . ' acompaña operaciones de compraventa con una metodología clara, sin promesas exageradas y con seguimiento continuo.',
                'points' => [
                    'Conocimiento real del mercado de Aix-en-Provence y el Pays d’Aix.',
            ...
            'finalCta' => [
                ...
                'text' => 'Hablemos de tu proyecto inmobiliario en Aix y alrededores.',
