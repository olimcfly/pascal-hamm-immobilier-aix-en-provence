        ...
        <div style="max-width:600px;margin:0 auto;text-align:center">
            ...
            <div style="background:var(--clr-bg);border-radius:var(--radius-xl);padding:2rem;border:1px solid var(--clr-border);margin-bottom:2rem;text-align:left">
                ...
                <?php foreach ([
                    ...
                    ['📞', 'Attendez l\'appel de Pascal', 'Pascal vous appellera dans les 24h pour un échange personnalisé.'],
                ...
                <div style="display:flex;gap:1rem;margin-bottom:1rem;align-items:flex-start">
                    ...
                    <div>
                        <strong style="display:block;margin-bottom:.2rem"><?= e($titre) ?></strong>
                        <span style="font-size:.875rem;color:var(--clr-text-muted)"><?= e($desc) ?></span>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
            ...
            <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap">
                <a href="<?= url('/biens') ?>" class="btn btn--primary">Voir les annonces</a>
