...
$pageTitle = 'Estimation instantanée — Pascal Hamm | Conseiller immobilier Aix-en-Provence';
$metaDesc = 'Obtenez une estimation immobilière indicative instantanée basée sur des comparables DVF pour Aix-en-Provence et le Pays d’Aix (13).';
...
<section class="section">
    <div class="container" style="max-width: 980px;">
        ...
        <p class="lead">Renseignez votre bien pour obtenir une fourchette indicative basée sur les données DVF (Pays d’Aix, 13).</p>
        ...
        <form id="instant-estimation-form" class="estimation-form" style="margin-top:1.5rem;">
            ...
            <div class="form-group">
                ...
                <input id="ie-location" name="location" class="form-control" type="text" required placeholder="Adresse, quartier ou commune (ex : Aix-en-Provence, 13100…)">
        ...
        <div id="instant-estimation-result" style="display:none;margin-top:1.5rem;border:1px solid var(--clr-border);padding:1.25rem;border-radius:var(--radius-lg);background:#fff;">
            ...
            <p style="font-size:.9rem;color:var(--clr-text-muted)">
                ...
                Les données sont issues des ventes réelles enregistrées sur le territoire local (Bouches-du-Rhône).
            </p>
            <a href="/prendre-rendez-vous" class="btn btn--accent" style="margin-top:.5rem;">Prendre rendez-vous avec Pascal Hamm</a>
        </div>
