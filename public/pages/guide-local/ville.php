...
$secteurs = [
    ...
    'aix-en-provence-centre' => [
        'nom'        => 'Aix-en-Provence — centre-ville',
        'prix'       => '5 200',
        'tendance'   => '↗ +3%',
        'delai'      => '38 jours',
        'biens'      => 14,
        'img'        => '/assets/images/aix-centre.jpg',
        'img_credit' => 'Cours Mirabeau — © <a href="https://commons.wikimedia.org/wiki/Category:Cours_Mirabeau_(Aix-en-Provence)" target="_blank" rel="noopener">Wikimedia Commons</a>',
        'desc'       => 'Le cœur historique d’Aix réunit le Cours Mirabeau, la vieille ville et ses hôtels particuliers du XVIIe siècle. Un secteur de prestige, plébiscité par les acquéreurs nationaux et internationaux.',
        ...
        'transports' => 'Toutes les lignes de bus Aix en Bus convergent vers le centre. La gare routière La Rotonde dessert Marseille, l\'aéroport Marseille-Provence et Avignon. La gare TGV d’Aix-en-Provence est à quelques minutes en bus. L\'accès en voiture est limité en hypercentre (zone piétonne).',
    ...
    'aix-mazarin' => [
        ...
        'img_credit' => 'Fontaine des Quatre-Dauphins — © <a href="https://commons.wikimedia.org/wiki/File:Fontaine_des_Quatre-Dauphins_01.jpg" target="_blank" rel="noopener">Wikimedia Commons</a> (CC BY-SA 3.0)',
    ...
    'eguilles' => [
        ...
        'commerces'  => 'Le village dispose de commerces de première nécessité, boulangerie, épicerie et pharmacie. Les marchés provençaux animent la place du village en saison. Aix-en-Provence est à environ 15 minutes pour toute l\'offre commerciale.',
        'habitat_pros' => [],
    ],
    ...
    'pertuis' => [
        ...
        'marche'     => 'Pertuis enregistre une progression soutenue, portée par la demande de maisons accessibles à l’ouest du département. Les maisons avec jardin représentent l\'essentiel des transactions. Le marché locatif est dynamique, porté par les salariés travaillant sur Aix ou Marseille.',
...
if (function_exists('cms_public_apply_publish_sections_to_assoc')) {
    cms_public_apply_publish_sections_to_assoc(
        CmsPageDiscovery::guideLocalCmsSlug($slug),
        $s,
        CmsPageDiscovery::guideSecteurOverlayKeys()
    );
}
...
$metaDesc  = 'Prix au m², tendances et analyse du marché immobilier à ' . $s['nom']
    . '. Conseils terrain de ' . ADVISOR_NAME . ', expert immobilier sur Aix-en-Provence et le Pays d\'Aix.';
