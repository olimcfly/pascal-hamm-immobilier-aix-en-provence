        ...
        <div class="container">
            <div class="guide-hero__inner">
                ...
                <p class="guide-hero__subtitle">
                    ...
                    les 6 étapes pour réussir votre achat immobilier sur Aix et le Pays d'Aix
                ...
                <main class="guide-main">
                    ...
                    <div class="guide-step" id="etape-1">
                        ...
                        <div class="guide-step__content">
                            ...
                            <p>
                                ...
                                Sur le marché d'Aix et du Pays d'Aix, très tendu, un dossier
                            ...
                            <p>
                                ...
                                Sur Aix et le Pays d’Aix, où le prix moyen au m² s’inscrit souvent au-dessus de
                                <strong>4 000 €</strong> dans les secteurs recherchés,
                    ...
                    <div class="guide-step" id="etape-2">
                        ...
                        <div class="guide-step__content">
                            ...
                            <p>
                                Aix et le Pays d’Aix offrent une grande diversité de biens :
                                appartements en centre et quartiers cossus (Mazarin, hauts du centre-ville),
                                maisons de ville, bastides en périphérie, maisons d’architecte sur collines
                                (Puyricard, hauteurs), programmes neufs aux Milles, Gardanne ou en Plaine. Définir précisément votre projet
                            ...
                            <div class="criteria-grid">
                                <div class="criteria-card criteria-card--must">
                                    ...
                                    <ul>
                                        ...
                                        <li>Secteur géographique (centre Aix, Mazarin, Puyricard, Les Milles, périphérie…)</li>
                                        <li>Type de bien (appartement, maison, villa / bastide)</li>
                                    </ul>
                                </div>
                                <div class="criteria-card criteria-card--want">
                                    ...
                                    <ul>
                                        <li>Parking / garage (souvent recherché en centre d’Aix)</li>
                                ...
                                <div class="criteria-card criteria-card--bonus">
                                    ...
                                    <ul>
                                        ...
                                        <li>Vue sur la Sainte-Victoire, jardin, ou vis-à-vis limité</li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="compare-table">
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Prix au m² (Aix, ordre d’idée)</td>
                                            <td>3 500 – 5 500 €</td>
                                            <td>4 200 – 6 000 €</td>
                                        </tr>
                                    </tbody>
                        ...
                        <div class="guide-step__header">
                            ...
                            <div>
                                ...
                                <p class="guide-step__subtitle">
                                    ...
                                    sur le marché de Aix et le Pays d’Aix.
                                </p>
                            </div>
                        </div>
                        <div class="guide-step__content">
                            ...
                            <?php
                            $sources = [
                                ['icon'=>'fa-building-user', 'name'=>'Agences locales Aix et le Pays d’Aix', 'pct'=>'45%',
                                 'tip'=>'Relation directe, biens off-market sur Aix et le Pays d\'Aix, Mazarin, Puyricard, Les Milles…', 'color'=>'blue'],
                                ...
                                ['icon'=>'fa-people-group',  'name'=>'Réseau personnel',              'pct'=>'12%',
                                 'tip'=>'Bouche à oreille — souvent les meilleures affaires dans les Bouches-du-Rhône',               'color'=>'purple'],
                                ['icon'=>'fa-gavel',         'name'=>'Notaires / ventes judiciaires', 'pct'=>'5%',
                                 'tip'=>'Successions, licitations — opportunités sur bastides provençales et grands terrains', 'color'=>'orange'],
                            ...
                            <div class="visit-checklist">
                                ...
                                $visit_items = [
                                    ...
                                    'Environnement' => [
                                        'Bruit (avenue, voisins, terrasses, rocade / périphérie) ?',
                                        'Ensoleillement et surchauffe estivale (exposition, stores, clim réversible)',
                                        'Vis-à-vis et intimité (mitoyenneté, résidence fermée ?)',
                                        'Stationnement disponible (centre d’Aix — zone payante, résidentiel, parkings souterrains)',
                                        'Proximité écoles, bus, cœur de quartier, commerces, commodités',
                                        'Proximité parcs (Torse, Sextius), forêt de la Sainte-Baume ou jardin (valeur +)',
                                    ],
                                    'Copropriété' => [
                    ...
                    <div class="guide-step" id="etape-4">
                        <div class="guide-step__header">
                            ...
                            <div>
                                ...
                                <p class="guide-step__subtitle">
                                    Comment négocier intelligemment sur le marché local
                        ...
                        <div class="guide-step__content">
                            ...
                            <p>
                                Le marché d’Aix et du Pays d’Aix est structurellement tendu.
                                Certains secteurs (Triangle d'Or, Mazarin, centre historique, vues)
                                se vendent au prix affiché voire au-dessus.
                                D’autres communes (Gardanne, péri 13) offrent parfois plus de marge.
                            </p>
                            ...
                            <div class="nego-grid">
                                <div class="nego-card nego-card--low">
                                    ...
                                    <p>Bien rare, Triangle d’or / Mazarin / vue dégagée. Offrir au prix ou au-dessus si concurrence.</p>
                                </div>
                                <div class="nego-card nego-card--mid">
                                    <div class="nego-card__pct">3 – 5 %</div>
                                    <div class="nego-card__label">Marché équilibré</div>
                                    <p>Marge sur secteurs périphériques du Pays d’Aix (Gardanne, Les Milles, péri) — justifiée par travaux ou comparaison de marché.</p>
                                </div>
                                ...
                                <div class="nego-card nego-card--max">
                                    ...
                                    <p>Succession urgente, mutation, problème de copropriété. Rare mais possible en communes rurales du 13 autour d’Aix.</p>
                                </div>
                            </div>
                    ...
                    <section class="guide-cta-final">
                        <div class="guide-cta-final__inner">
                            ...
                            <h2>Prêt à acheter sur Aix et le Pays d’Aix ?</h2>
                            <p>
                                <?= ADVISOR_NAME ?> vous accompagne de A à Z dans votre
                                projet immobilier à Aix-en-Provence et sa Métropole.
                            ...
                            <div class="guide-cta-final__actions">
                                ...
                                <a href="/biens" class="btn btn--outline btn--lg">
                                    ...
                                    Voir les biens disponibles à Aix-en-Provence et Métropole
                                </a>
                            </div>
                ...
                <aside class="guide-sidebar" id="guideSidebar">
                    ...
                    <div class="sidebar-card sidebar-card--testimonial">
                        ...
                        <blockquote class="sidebar-testimonial__text">
                            ...
                            j'ai trouvé mon appartement en 3 semaines
                        ...
                        <div class="sidebar-testimonial__author">
                            ...
                            <div>
                                ...
                                <span>Acheteuse — Pays d'Aix</span>
                            </div>
                        </div>
                    </div>
