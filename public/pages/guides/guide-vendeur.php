        ...
        <div class="container">
            <div class="guide-hero__inner">
                ...
                <p class="guide-hero__subtitle">
                    ...
                    les 6 étapes pour vendre sereinement sur Aix et le Pays d’Aix,
                ...
                <main class="guide-main">
                    ...
                    <div class="guide-intro-box guide-intro-box--vendeur">
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                de mettre votre bien sur le marché local.
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="guide-step" id="etape-1">
                        ...
                        <div class="guide-step__content">
                            ...
                            <p>
                                Sur le marché de Aix et le Pays d’Aix, le prix au m² varie
                                fortement selon le secteur : de <strong>3 000 €/m²</strong>
                                en périphérie à plus de <strong>6 000 €/m²</strong>
                                en hypercentre (Mazarin, hauts du centre-ville, Cours Mirabeau).
                            ...
                            <?php
                            $secteurs = [
                                ['name' => 'Triangle d\'or / Cours Mirabeau',  'min' => '5 000', 'max' => '6 500+', 'color' => 'red'],
                                ['name' => 'Mazarin / Sextius / Ville d\'Aix', 'min' => '4 500', 'max' => '5 800',  'color' => 'orange'],
                                ['name' => 'Jas-de-Bouffan / Palais des Arts', 'min' => '3 800', 'max' => '5 000',  'color' => 'yellow'],
                                ['name' => 'Puyricard / hauteurs nord',         'min' => '3 500', 'max' => '4 500',  'color' => 'green'],
                                ['name' => 'Les Milles / Luynes',              'min' => '3 000', 'max' => '4 200',  'color' => 'blue'],
                                ['name' => 'Gardanne / péri 13 périphérie',   'min' => '2 800', 'max' => '3 800',  'color' => 'purple'],
                            ];
                            ?>
                            <div class="secteur-grid">
                                <h3>Prix au m² par secteur de Aix et le Pays d’Aix (2025)</h3>
                            ...
                            $methods = [
                                ...
                                [
                                    ...
                                    'desc'  => 'Un agent immobilier connaissant Aix et le Pays d’Aix croise ventes récentes, caractéristiques intrinsèques et état du marché actuel. La méthode la plus précise et la plus rapide.',
                                ...
                                [
                                    ...
                                    'desc'  => 'SeLoger, MeilleursAgents, Meilleurs Taux… donnent une fourchette indicative en quelques secondes. Utile pour un premier cadrage, mais insuffisant seul — les algorithmes ne connaissent pas la vue sur la Sainte-Victoire ou le calme de votre impasse à Aix.',
                    ...
                    <div class="guide-step" id="etape-2">
                        ...
                        <div class="guide-step__content">
                            ...
                            <p>
                                À Aix, le charme du bâti ancien (hôtels particuliers, pierres) et les extérieurs sont des
                            ...
                            $diagnostics = [
                                ...
                                ['ERP',          'État des Risques et Pollutions — risques naturels, inondation (ruissellement, crues, repères historiques en Provence), retrait-gonflement des argiles. Validité 6 mois. Zonage PPRI / PPR à vérifier à Aix-en-Provence.'],
                                ['Mérule',       'Obligatoire dans les zones à risque définies par arrêté préfectoral.'],
                                ['Assainissement','Non-collectif obligatoire si pas raccordé au réseau public (fréquent en périphérie de Aix et le Pays d’Aix).'],
                            ];
                            ...
                            <div class="compare-cards">
                                ...
                                <div class="compare-card compare-card--recommended">
                                    ...
                                    <ul class="compare-card__pros">
                                        ...
                                        <li><i class="fas fa-check"></i> Réseau acheteurs qualifiés Aix et le Pays d’Aix</li>
                    ...
                    <div class="guide-step" id="etape-4">
                        ...
                        <div class="guide-step__content">
                            ...
                            <p>
                                À Aix, la luminosité naturelle est votre meilleur allié.
                                Planifiez les visites aux heures où votre bien est
                                le plus lumineux. Un appartement orienté plein sud ou plein ouest
                                gagne à être montré quand le soleil met en valeur les volumes.
                            </p>
                            ...
                            $visit_tips = [
                                [
                                    ...
                                    'desc'  => 'Ouvrez tous les volets et fenêtres 30 minutes avant. La lumière sur la pierre d’Aix et les moulures se prête particulièrement à une visite en journée.',
                                ],
                                [
                                ...
                                [
                                    ...
                                    'desc'  => 'Arrosez la veille, sortez le mobilier de jardin. Un extérieur soigné à Aix et le Pays d’Aix peut faire la différence à lui seul.',
                                ],
                                [
                                    'icon'  => 'fa-comments',
                    ...
                    <div class="guide-step" id="etape-5">
                        ...
                        <div class="guide-step__content">
                            ...
                            <p>
                                Sur le marché local, si votre bien est correctement
                            ...
                            <div class="nego-grid">
                                ...
                                <div class="nego-card nego-card--max">
                                    ...
                                    <p>Soit le bien est surestimé (réévaluez), soit l'acheteur n'est pas sérieux. Ne bradez pas — le marché local reste solide.</p>
                                </div>
                            </div>
                    ...
                    <section class="guide-cta-final">
                        <div class="guide-cta-final__inner">
                            ...
                            <h2>Prêt à vendre sur Aix et le Pays d’Aix ?</h2>
                            <p>
                                <?= ADVISOR_NAME ?> vous accompagne de A à Z dans votre
                                projet de vente à Aix-en-Provence et sa Métropole.
                            ...
                            <p class="guide-cta-final__reassurance">
                                <i class="fas fa-lock"></i>
                                Sans engagement · Réponse sous 24h · 100% gratuit · Expert local Aix et le Pays d’Aix
                            </p>
                        </div>
                    </section>
                ...
                <aside class="guide-sidebar" id="guideSidebar">
                    ...
                    <div class="sidebar-card sidebar-card--contact">
                        ...
                        <p class="sidebar-advisor__quote">
                            "<?= htmlspecialchars($advisor['quote'] ?? "Je vous accompagne pour vendre votre bien au meilleur prix sur Aix et le Pays d'Aix et sa Métropole.") ?>"
                        </p>
                    ...
                    <div class="sidebar-card sidebar-card--testimonial">
                        ...
                        <blockquote class="sidebar-testimonial__text">
                            "Pascal a vendu notre appartement
                        ...
                        <div class="sidebar-testimonial__author">
                            ...
                            <div>
                                ...
                                <span>Vendeur — Aix-en-Provence</span>
                            </div>
                        </div>
                    </div>
