...
$metaDesc     = 'Expert immobilier au Jas de Bouffan (Aix) : quartier résidentiel à l’ouest du centre, maisons, résidences, écoles et accès pratique vers les axes (rocade, A7, A8).';
...
<section class="hero hero--premium" aria-labelledby="jas-hero-title">
    ...
    <div class="container">
        <div class="hero__content" data-animate>
            ...
            <p class="hero__subtitle">Côté ouest d’Aix, le Jas de Bouffan est un quartier résidentiel recherché : maisons, résidences, espaces verts, scolarité et proximité des commodités. Le domaine a inspiré Cézanne (patrimoine culturel) ; l’offre actuelle mêle pavillons, copropriétés et programmes récents.</p>
...
<section class="section section--alt" id="jas-intro">
    <div class="container">
        <div class="section__header">
            ...
            <p class="section-subtitle">L’histoire rappelle le lien avec Cézanne ; aujourd’hui le quartier s’inscrit dans l’ouest aixois : familles, résidences calmes, accès commerces et périphérie sans traverser le centre (selon itinéraires).</p>
        </div>
        <div class="grid-2">
            ...
            <div class="card card--alt" data-animate>
                ...
                <p class="card__text">Segment souvent plus accessible que l’hypercentre tout en restant proche de la ville pour les services quotidiens.</p>
            </div>
        </div>
    </div>
</section>
