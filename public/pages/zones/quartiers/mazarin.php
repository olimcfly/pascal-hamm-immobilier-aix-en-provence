...
$metaDesc     = 'Expert immobilier dans le quartier Mazarin (Aix-en-Provence) : hôtels particuliers, appartements d’exception, rues calmes et patrimoine classé.';
$metaKeywords = 'immobilier Mazarin Aix, quartier Mazarin, hôtel particulier Aix, expert immobilier 13, prestige Aix';
...
<section class="hero hero--premium" aria-labelledby="mazarin-hero-title">
    ...
    <div class="container">
        <div class="hero__content" data-animate>
            ...
            <p class="hero__subtitle">Aix possède l\'un des premiers « quartiers à l\'italienne » de France. Le Mazarin, tracé au XVIIe siècle, concentre hôtels particuliers, façades richement ouvragées, calme résidentiel et proximité du centre historique (Cours Mirabeau).</p>
