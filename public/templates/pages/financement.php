...
/**
 * Template page : FINANCEMENT
 */

$pageTitle = trim((string) ($page['meta_title'] ?? $page['title'] ?? 'Financement immobilier'));
...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/financement.css">
</head>
<body class="page-template page-template-financement">
