...
/**
 * Template page : RESOURCE LIBRARY (guides / PDF / lead magnets)
 *
 * Fichier :
 * /public/templates/pages/resource-library.php
 */

$pageTitle = trim((string) ($page['meta_title'] ?? $page['title'] ?? 'Ressources'));
...
<body class="page-template page-template-resource-library">
