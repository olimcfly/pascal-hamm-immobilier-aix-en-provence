...
/**
 * Template page : RESOURCE SINGLE
 *
 * Fichier :
 * /public/templates/pages/resource-single.php
 */

$pageTitle = trim((string) ($page['meta_title'] ?? $page['title'] ?? 'Ressource'));
...
<body class="page-template page-template-resource-single">
