...
<?php
/**
 * Applique database/migrations/032_guide_local_poi.sql (tables POI guide local).
 * Usage depuis la racine du projet :
 *   php scripts/run-migration-032.php
 * Utilise les variables DB_* du fichier .env
 */
declare(strict_types=1);

$root = dirname(__DIR__);
$envFile = $root . '/.env';
$sqlFile = $root . '/database/migrations/032_guide_local_poi.sql';
...
echo "OK — migration 032 appliquée (guide_poi_categories, guide_pois, guide_poi_media + seeds).\n";
$mysqli->close();
exit(0);
