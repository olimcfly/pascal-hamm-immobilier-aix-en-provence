...
<?php
/**
 * Applique database/migrations/035_financement_crm_sequence.sql
 * Usage : php scripts/run-migration-035.php
 */
declare(strict_types=1);

$root = dirname(__DIR__);
$envFile = $root . '/.env';
$sqlFile = $root . '/database/migrations/035_financement_crm_sequence.sql';
...
echo "OK — migration 035 appliquée (séquence CRM financement + 3 e-mails).\n";
$mysqli->close();
exit(0);
