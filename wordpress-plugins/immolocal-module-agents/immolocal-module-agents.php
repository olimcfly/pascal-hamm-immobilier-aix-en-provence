<?php
/**
 * Plugin Name: IMMO Local+ - agents
 * Description: Pont WordPress / module admin IMMO (Agents IA).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-agents
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'agents',
    'Agents IA',
    'Configuration des agents d’intelligence artificielle et automatisations associées.',
    false
);
