<?php
/**
 * Plugin Name: IMMO Local+ - ai-help-chat
 * Description: Pont WordPress / module admin IMMO (Chat d’aide IA).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-ai-help-chat
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'ai-help-chat',
    'Chat d’aide IA',
    'Assistance par conversation (réponses et guidage contextuel).',
    false
);
