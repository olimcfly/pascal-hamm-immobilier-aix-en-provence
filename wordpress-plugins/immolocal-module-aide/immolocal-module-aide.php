<?php
/**
 * Plugin Name: IMMO Local+ - aide
 * Description: Pont WordPress / module admin IMMO (Aide & documentation).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-aide
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'aide',
    'Aide & documentation',
    'Centre d’aide, vidéos et ressources pour utiliser l’espace client.',
    false
);
