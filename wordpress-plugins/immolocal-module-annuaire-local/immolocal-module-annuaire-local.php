<?php
/**
 * Plugin Name: IMMO Local+ - annuaire-local
 * Description: Pont WordPress / module admin IMMO (Annuaire local).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-annuaire-local
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'annuaire-local',
    'Annuaire local',
    'Fiches locales, partenaires et présence de proximité.',
    false
);
