<?php
/**
 * Plugin Name: IMMO Local+ - api-keys
 * Description: Pont WordPress / module admin IMMO (Clés API).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-api-keys
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'api-keys',
    'Clés API',
    'Gestion des clés d’API pour services externes (LLM, outils, etc.).',
    false
);
