<?php
/**
 * Plugin Name: IMMO Local+ - attirer
 * Description: Pont WordPress / module admin IMMO (Être trouvé).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-attirer
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'attirer',
    'Être trouvé',
    'Visibilité et SEO : être trouvé par les bons prospects au bon moment.',
    false
);
