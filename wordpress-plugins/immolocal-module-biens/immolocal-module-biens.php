<?php
/**
 * Plugin Name: IMMO Local+ - biens
 * Description: Pont WordPress / module admin IMMO (Biens).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-biens
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'biens',
    'Biens',
    'Liste et gestion des annonces / biens (back-office).',
    false
);
