<?php
/**
 * Plugin Name: IMMO Local+ - blog
 * Description: Pont WordPress / module admin IMMO (Blog & articles).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-blog
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'blog',
    'Blog & articles',
    'Gestion des articles, catégories et publication du blog.',
    false
);
