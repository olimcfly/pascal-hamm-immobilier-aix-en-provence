<?php
/**
 * Plugin Name: IMMO Local+ - capture
 * Description: Pont WordPress / module admin IMMO (Attirer des demandes).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-capture
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    ...
    'Capter des contacts et des leads (formulaires, offres, conversions).',
    false
);
