<?php
/**
 * Plugin Name: IMMO Local+ - capturer
 * Description: Pont WordPress / module admin IMMO (Leads (vue CRM)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-capturer
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'capturer',
    'Leads (vue CRM)',
    'File de leads rattachée à la phase de capture (vue altern.).',
    false
);
