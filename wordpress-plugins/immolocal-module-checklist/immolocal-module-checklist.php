<?php
/**
 * Plugin Name: IMMO Local+ - checklist
 * Description: Pont WordPress / module admin IMMO (Checklist client).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-checklist
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'checklist',
    'Checklist client',
    'Listes de vérification partageables avec le client (lancement, conformité, etc.).',
    false
);
