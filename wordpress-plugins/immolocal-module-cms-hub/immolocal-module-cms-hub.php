<?php
/**
 * Plugin Name: IMMO Local+ - cms-hub
 * Description: Pont WordPress / module admin IMMO (Pages & contenus).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-cms-hub
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'cms-hub',
    'Pages & contenus',
    'Contenu, pages structurantes et textes du site public.',
    false
);
