<?php
/**
 * Plugin Name: IMMO Local+ - cms
 * Description: Pont WordPress / module admin IMMO (CMS (pages)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-cms
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'cms',
    'CMS (pages)',
    'Gestion de pages type CMS (hors hub regroupé).',
    false
);
