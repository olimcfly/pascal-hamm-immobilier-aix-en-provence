<?php
/**
 * Plugin Name: IMMO Local+ - commencer
 * Description: Pont WordPress / module admin IMMO (Par où commencer).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-commencer
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'commencer',
    'Par où commencer',
    'Premiers réglages, repères et enchaînement des étapes pour démarrer sereinement.',
    false
);
