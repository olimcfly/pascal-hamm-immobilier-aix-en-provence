<?php
/**
 * Plugin Name: IMMO Local+ - construire
 * Description: Pont WordPress / module admin IMMO (Construire).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-construire
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'construire',
    'Construire',
    'Fondations marketing, persona et système d’acquisition (parcours « Construire »).',
    false
);
