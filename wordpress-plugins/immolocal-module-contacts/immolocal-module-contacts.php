<?php
/**
 * Plugin Name: IMMO Local+ - contacts
 * Description: Pont WordPress / module admin IMMO (Contacts & leads (détail)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-contacts
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'contacts',
    'Contacts & leads (détail)',
    'Détail des contacts et piste de traitement (hors hub).',
    false
);
