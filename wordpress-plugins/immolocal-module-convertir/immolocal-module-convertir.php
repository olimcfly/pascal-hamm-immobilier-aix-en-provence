<?php
/**
 * Plugin Name: IMMO Local+ - convertir
 * Description: Pont WordPress / module admin IMMO (Conclure).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-convertir
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'convertir',
    'Conclure',
    'Process de vente, rendez-vous, arguments et clôture (conversion).',
    false
);
