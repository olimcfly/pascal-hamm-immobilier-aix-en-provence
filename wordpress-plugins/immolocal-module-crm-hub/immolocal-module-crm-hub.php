<?php
/**
 * Plugin Name: IMMO Local+ - crm-hub
 * Description: Pont WordPress / module admin IMMO (Contacts & suivi).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-crm-hub
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'crm-hub',
    'Contacts & suivi',
    'Vue CRM : leads, suivi, statuts et historique dՎchanges.',
    false
);
