<?php
/**
 * Plugin Name: IMMO Local+ - dashboard
 * Description: Pont WordPress / module admin IMMO (Tableau de bord).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-dashboard
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'dashboard',
    'Tableau de bord',
    'Vue d’ensemble de l’activité, accès rapide aux parcours et statistiques clés.',
    true
);
