<?php
/**
 * Plugin Name: IMMO Local+ - email-sequences
 * Description: Pont WordPress / module admin IMMO (Séquences e-mail).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-email-sequences
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'email-sequences',
    'Séquences e-mail',
    'Séquences d’e-mails automatisées (scénarios, étapes, envois).',
    false
);
