<?php
/**
 * Plugin Name: IMMO Local+ - estimation_dvf
 * Description: Pont WordPress / module admin IMMO (Estimation DVF (admin)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-estimation-dvf
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'estimation_dvf',
    'Estimation DVF (admin)',
    'Pilote des données DVF et demandes d’estimation côté opérationnel.',
    false
);
