<?php
/**
 * Plugin Name: IMMO Local+ - estimation
 * Description: Pont WordPress / module admin IMMO (Estimation (tunnel)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-estimation
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'estimation',
    'Estimation (tunnel)',
    'Outils d’estimation immobilière et tunnel associé côté admin.',
    false
);
