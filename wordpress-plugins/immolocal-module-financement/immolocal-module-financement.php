<?php
/**
 * Plugin Name: IMMO Local+ - financement
 * Description: Pont WordPress / module admin IMMO (Financement (demandes)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-financement
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    ...
    'Traitement des demandes de prêt / financement reçues via le site.',
    false
);
