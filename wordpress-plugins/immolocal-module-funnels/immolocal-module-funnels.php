<?php
/**
 * Plugin Name: IMMO Local+ - funnels
 * Description: Pont WordPress / module admin IMMO (Entonnoirs (funnels)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-funnels
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'funnels',
    'Entonnoirs (funnels)',
    'Pipelines, tunnels de conversion et scénarios multi-étapes.',
    false
);
