<?php
/**
 * Plugin Name: IMMO Local+ - generateur-contenu
 * Description: Pont WordPress / module admin IMMO (Générateur de contenu).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-generateur-contenu
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    ...
    'Aide à la rédaction et génération de contenus (textes, fiches, etc.).',
    false
);
