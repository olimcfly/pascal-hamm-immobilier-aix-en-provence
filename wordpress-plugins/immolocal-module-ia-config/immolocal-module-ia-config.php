<?php
/**
 * Plugin Name: IMMO Local+ - ia-config
 * Description: Pont WordPress / module admin IMMO (Configuration IA).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-ia-config
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'ia-config',
    'Configuration IA',
    'Fournisseurs, modèles et réglages des fonctionnalités IA du site.',
    false
);
