<?php
/**
 * Plugin Name: IMMO Local+ - landing-pages
 * Description: Pont WordPress / module admin IMMO (Landing pages (ads)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-landing-pages
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'landing-pages',
    'Landing pages (ads)',
    'Pages d’atterrissage publicitaires et liens de campagne (UTM, tracking).',
    false
);
