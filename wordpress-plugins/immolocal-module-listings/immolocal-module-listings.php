<?php
/**
 * Plugin Name: IMMO Local+ - listings
 * Description: Pont WordPress / module admin IMMO (Listings (flux)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-listings
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'listings',
    'Listings (flux)',
    'Gestion de flux et formats d’annonces (synchronisation / exports).',
    false
);
