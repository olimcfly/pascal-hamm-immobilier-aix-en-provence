<?php
/**
 * Plugin Name: IMMO Local+ - marketing-hub
 * Description: Pont WordPress / module admin IMMO (Marketing & relances).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-marketing-hub
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'marketing-hub',
    'Marketing & relances',
    'Relances, automations et actions marketing ciblées.',
    false
);
