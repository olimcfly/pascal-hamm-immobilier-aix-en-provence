<?php
/**
 * Plugin Name: IMMO Local+ - messagerie
 * Description: Pont WordPress / module admin IMMO (Messagerie).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-messagerie
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'messagerie',
    'Messagerie',
    'Messages entrants / sortants, boîte de réception pro.',
    false
);
