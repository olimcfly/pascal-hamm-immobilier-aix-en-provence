<?php
/**
 * Plugin Name: IMMO Local+ - newsletter
 * Description: Pont WordPress / module admin IMMO (Newsletter).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-newsletter
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'newsletter',
    'Newsletter',
    'Inscriptions, envois et veille sur l’e-mail de masse (news).',
    false
);
