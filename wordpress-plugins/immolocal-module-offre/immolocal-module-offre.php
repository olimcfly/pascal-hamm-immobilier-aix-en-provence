<?php
/**
 * Plugin Name: IMMO Local+ - offre
 * Description: Pont WordPress / module admin IMMO (Ce que vous proposez).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-offre
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    ...
    'Décrire l’offre, les services et la promesse commerciale.',
    false
);
