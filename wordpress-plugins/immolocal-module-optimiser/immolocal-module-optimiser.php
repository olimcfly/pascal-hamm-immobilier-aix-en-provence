<?php
/**
 * Plugin Name: IMMO Local+ - optimiser
 * Description: Pont WordPress / module admin IMMO (Faire mieux).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-optimiser
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'optimiser',
    'Faire mieux',
    'Analytics, A/B, rapports : améliorer le pilotage des performances.',
    false
);
