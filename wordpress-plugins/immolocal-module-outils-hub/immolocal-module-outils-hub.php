<?php
/**
 * Plugin Name: IMMO Local+ - outils-hub
 * Description: Pont WordPress / module admin IMMO (Outils & exports).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-outils-hub
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'outils-hub',
    'Outils & exports',
    'Outils, téléchargements, scripts et ressources opérationnelles.',
    false
);
