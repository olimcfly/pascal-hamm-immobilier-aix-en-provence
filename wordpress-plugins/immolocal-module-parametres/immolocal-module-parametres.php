<?php
/**
 * Plugin Name: IMMO Local+ - parametres
 * Description: Pont WordPress / module admin IMMO (Paramètres).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-parametres
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'parametres',
    'Paramètres',
    'Paramètres techniques, messagerie, intégrations et options avancées.',
    false
);
