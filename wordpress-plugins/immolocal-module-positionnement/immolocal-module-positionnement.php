<?php
/**
 * Plugin Name: IMMO Local+ - positionnement
 * Description: Pont WordPress / module admin IMMO (Votre position).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-positionnement
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'positionnement',
    'Votre position',
    'Se positionner sur le marché : cible, promesse, différenciation.',
    false
);
