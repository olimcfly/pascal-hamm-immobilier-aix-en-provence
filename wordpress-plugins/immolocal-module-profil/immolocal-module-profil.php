<?php
/**
 * Plugin Name: IMMO Local+ - profil
 * Description: Pont WordPress / module admin IMMO (Mon profil).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-profil
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'profil',
    'Mon profil',
    'Identité pro, contact affiché et personnalisation du compte.',
    false
);
