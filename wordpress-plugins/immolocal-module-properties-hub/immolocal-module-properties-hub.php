<?php
/**
 * Plugin Name: IMMO Local+ - properties-hub
 * Description: Pont WordPress / module admin IMMO (Annonces & secteurs).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-properties-hub
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'properties-hub',
    'Annonces & secteurs',
    'Mandats, annonces, secteurs et cadrage offre / zones.',
    false
);
