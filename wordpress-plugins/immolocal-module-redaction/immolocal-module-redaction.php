<?php
/**
 * Plugin Name: IMMO Local+ - redaction
 * Description: Pont WordPress / module admin IMMO (Rédaction).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-redaction
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'redaction',
    'Rédaction',
    'Brouillons, fiches de style et atelier rédactionnel.',
    false
);
