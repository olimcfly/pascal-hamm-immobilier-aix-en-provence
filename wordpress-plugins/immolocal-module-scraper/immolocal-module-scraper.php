<?php
/**
 * Plugin Name: IMMO Local+ - scraper
 * Description: Pont WordPress / module admin IMMO (Scraper (web)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-scraper
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'scraper',
    'Scraper (web)',
    'Outils d’extraction de données sur le web (crawl / parsing).',
    false
);
