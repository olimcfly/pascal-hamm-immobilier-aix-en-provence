<?php
/**
 * Plugin Name: IMMO Local+ - scraping
 * Description: Pont WordPress / module admin IMMO (Scraping (eXp / flux)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-scraping
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'scraping',
    'Scraping (eXp / flux)',
    'Pipelines de scraping dédiés (eXp France, imports structurés).',
    false
);
