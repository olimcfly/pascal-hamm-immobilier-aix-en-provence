<?php
/**
 * Plugin Name: IMMO Local+ - secteurs
 * Description: Pont WordPress / module admin IMMO (Secteurs & zones).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-secteurs
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'secteurs',
    'Secteurs & zones',
    'Cartographie des secteurs, villes, quartiers et contenus de zone.',
    false
);
