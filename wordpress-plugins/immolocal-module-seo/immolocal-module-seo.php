<?php
/**
 * Plugin Name: IMMO Local+ - seo
 * Description: Pont WordPress / module admin IMMO (SEO (détaillé)).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-seo
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'seo',
    'SEO (détaillé)',
    'Ecran SEO avancé (hors attirer) : mots-clés, structure, outils de pilotage.',
    false
);
