<?php
/**
 * Plugin Name: IMMO Local+ - site
 * Description: Pont WordPress / module admin IMMO (Site public).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-site
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'site',
    'Site public',
    'Aperçu et paramètres liés au site vitrine côté public.',
    false
);
