<?php
/**
 * Plugin Name: IMMO Local+ - social
 * Description: Pont WordPress / module admin IMMO (Réseaux sociaux).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-social
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'social',
    'Réseaux sociaux',
    'Réseaux sociaux, posts et liens de diffusion.',
    false
);
