<?php
/**
 * Plugin Name: IMMO Local+ - superadmin
 * Description: Pont WordPress / module admin IMMO (Superadmin).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-superadmin
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'superadmin',
    'Superadmin',
    'Outils d’administration avancés et accès directs (réservé).',
    false
);
