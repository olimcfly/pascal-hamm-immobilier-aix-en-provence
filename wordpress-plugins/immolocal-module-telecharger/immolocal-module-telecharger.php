<?php
/**
 * Plugin Name: IMMO Local+ - telecharger
 * Description: Pont WordPress / module admin IMMO (Téléchargements).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-telecharger
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'telecharger',
    'Téléchargements',
    'Fichiers et ressources à mettre à disposition des visiteurs ou de l’équipe.',
    false
);
