<?php
/**
 * Plugin Name: IMMO Local+ - telegram
 * Description: Pont WordPress / module admin IMMO (Bot Telegram).
 * Version: 1.0.0
 * Author: Immo local team
 * Text Domain: immolocal-module-telegram
...
\IMMO_Local_Plus_Parent::registerSubmodule(
    'telegram',
    'Bot Telegram',
    'Intégration du bot Telegram (webhooks, notifications, commandes).',
    false
);
